public static partial class ToonLibrary
{
    ...
    {
        public static class WalkBackwardWithRootMotion
        {
            public const string Name = "Walk Backward With Root Motion";

            public const string TriggerName = WalkBackward.Name;
